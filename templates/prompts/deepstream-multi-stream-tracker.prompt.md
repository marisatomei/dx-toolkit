---
name: deepstream-multi-stream-tracker
description: 'Generate a DeepStream pyservicemaker Python app that streams from 4 RTSP cameras, runs ResNet18 inference with tracking, and displays a 2x2 tiled output window.'
agent: agent
tools:
  - read
  - edit
...
- Stream from 4 RTSP cameras simultaneously, decode the videos, batch frames together and infer using
